  ...
  return (
    <div className="bg-white flex w-full h-screen items-stretch justify-center">
      ...
      <main className="bg-white w-full">
        <div id='home' className='bg-gradient-to-b from-gray-900 via-gray-950 to-gray-900 flex flex-col md:flex-row h-screen w-full justify-center items-center'>
          <Image
            unoptimized
            className='md:hidden'
            width={250}
            ...
            alt="Tech Hiring"
          />
          <div className='flex flex-col md:h-screen w-full md:w-1/2 justify-center items-center'>
            <Image
              unoptimized
        ...
        <div id='solution' className='bg-gradient-to-b from-gray-900 via-gray-950 to-gray-900 border-y border-black flex flex-row h-screen w-full justify-center items-center'>
          <div className='flex flex-col h-screen w-full justify-center items-center'>
            <Image
              unoptimized
              className='rounded-lg md:hidden md:mb-10 shadow-lg'
              src={'/job-hunt.png'}
              width={250}
              height={200}
            />
        ...
        <div id='impact' className='bg-gradient-to-b from-gray-900 via-gray-950 to-gray-900 md:pt-5 md:pb-5 md:pr-20 flex flex-col md:flex-row h-screen w-full justify-center items-center'>
